    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tournaments', to='quiz.Tournament')),
        ...
        migrations.AddField(
            model_name='user',
            name='interest',
            field=models.ManyToManyField(blank=True, related_name='interested_players', to='quiz.Category'),
        ),
        migrations.AddField(
            model_name='user',
